...
# File: BUZZER.tcl
# Generated on: Mon May 10 18:04:11 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "BUZZER"]} {
		puts "Project BUZZER is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists BUZZER]} {
		project_open -revision BUZZER BUZZER
	} else {
		project_new -revision BUZZER BUZZER
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "15:01:41  MAY 10, 2021"
